About gmpyinfr_telegram-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gmpyinfr_telegram-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12319&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gmpyinfr_telegram-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gmpyinfr_telegram` can be installed with `conda`:
...
```
mamba install gmpyinfr_telegram
```

It is possible to list all of the versions of `gmpyinfr_telegram` available on your platform with `conda`:
...
```
mamba search gmpyinfr_telegram --channel conda-forge
```
...
mamba repoquery search gmpyinfr_telegram --channel conda-forge

# List packages depending on `gmpyinfr_telegram`:
mamba repoquery whoneeds gmpyinfr_telegram --channel conda-forge

# List dependencies of `gmpyinfr_telegram`:
mamba repoquery depends gmpyinfr_telegram --channel conda-forge
```
